...
async def get_multiple_projects(request):
    # No GID Required
    # No Body Parameters
    # Optional Paramaters:
    ...
    try:
        ...
        result = list(client.projects.get_projects(
            {'workspace': id, 'body': body}, opt_pretty=True))
        response_obj = {'message': "Get Asana projects Success",
                        'results': result, }
        ...
        response_obj = {'message': "Get Asana projects Failed",
